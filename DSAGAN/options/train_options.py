...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--learning_rate_psp', default=0.00001, type=float, help='Optimizer learning rate for psp')
		...
		self.parser.add_argument("--add_triplanenet", type=int, default=2000000, help='Steps after which triplanenet training starts')
		self.parser.add_argument("--stop_psp", type=int, default=50000000, help='Steps after which psp training stops')
		...
		self.parser.add_argument('--max_steps', default=100000000, type=int, help='Maximum number of training steps')
