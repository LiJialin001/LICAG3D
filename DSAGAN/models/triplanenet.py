...
class TriPlaneNet(nn.Module):
    ...
    def set_psp_encoder(self):
        ...
        # self.psp_encoder = psp_encoders.GradualStyleEncoder(100, 'ir_se', self.opts)
        # self.psp_encoder = psp_encoders.GradualStyleEncoder(152, 'ir_se', self.opts)
